...
# The FLAME pickle references chumpy, which is old and expects APIs removed from
# recent Python/NumPy releases. Patch only the legacy names needed during import.
